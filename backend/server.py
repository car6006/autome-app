...
async def process_youtube_video(
    ...
    try:
        ...
        with open(result['audio_file_path'], 'rb') as audio_file:
            media_key = await store_file(audio_file.read(), f"{note_title}.wav")
        ...
        await NotesStore.create_note(note_data)
        
        # Enqueue transcription
        background_tasks.add_task(enqueue_transcription, note_data["id"])
